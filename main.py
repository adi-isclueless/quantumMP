...
state_choice = st.sidebar.selectbox("Choose Bell State", ["Φ+", "Φ-", "Ψ+", "Ψ-"])
noise_choice = st.sidebar.selectbox("Choose Noise Model", ["None", "Depolarizing", "Amplitude Damping", "Phase Damping"])
strength = st.sidebar.slider("Noise Strength", 0.0, 0.3, 0.05)
shots = st.sidebar.number_input("Number of Shots", min_value=128, max_value=20000, value=1000, step=128)
